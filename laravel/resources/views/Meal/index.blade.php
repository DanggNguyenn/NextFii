  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container mt-5">
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><button><a href='meal/{{$item['id']}}/edit'>Edit</a></button></td>
              <td>
                <form action='meal/{{$item['id']}}' method="POST" style="display:inline;">
                @csrf
                @method('DELETE')
        ...
        <td><button><a href='/meal/create'>Create</a></button></td>
      </div>
