  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container mt-5">
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$item['address']}}</td>
              <td>{{$item['phone']}}</td>
              <td><button><a href='restaurant/{{$item['id']}}/edit'>Edit</a></button></td>
              <td>
                <form action='restaurant/{{$item['id']}}' method="POST" style="display:inline;">
                @csrf
                @method('DELETE')
        ...
        <td><button><a href='/restaurant/create'>Create</a></button></td>
      </div>
      <!-- /.row -->
      <!-- Main row -->
