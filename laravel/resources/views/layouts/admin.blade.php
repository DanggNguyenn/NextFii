      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://127.0.0.1:8000/meal/"><i class="fa fa-circle-o"></i> Meal</a></li>
            <li><a href="http://127.0.0.1:8000/restaurant/"><i class="fa fa-circle-o"></i> Restaurant</a></li>
            <li><a href="http://127.0.0.1:8000/lunchrequest"><i class="fa fa-circle-o"></i> lunch_requests</a></li>
            <li><a href="http://127.0.0.1:8000/lunchchoice"><i class="fa fa-circle-o"></i> lunch_choices</a></li>
          </ul>
        </li>
      </ul>
        </li>
